...
<nav class="menu_list" >
    ...
    <a class="menu_link-anchor"
        id="menu-item-:r7c:" role="menuitem" tabindex="-1" href="/#proyectos"><svg
    ...
    <a class="menu_link-anchor" id="menu-item-:r7d:"
        role="menuitem" tabindex="-1" href="/#habilidades"><svg xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" height="24px">
            <path fill-rule="evenodd"
...
<section class="menu_list" role="none">
    ...
    <section class="menu_modes" role="none">
            <button class="menu_mode" id="headlessui-menu-item-:r7f:"
                role="menuitem" tabindex="-1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                    fill="currentColor" aria-hidden="true" width="24">
                    <path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path>
                </svg> Oscuro
            </button>

            <button class="menu_mode menu_active" id="headlessui-menu-item-:r7g:" role="menuitem"
                tabindex="-1"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
            ...
            <button class="menu_mode"
                id="headlessui-menu-item-:r7h:" role="menuitem" tabindex="-1"><svg xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" width="24">
                    <path fill-rule="evenodd"
